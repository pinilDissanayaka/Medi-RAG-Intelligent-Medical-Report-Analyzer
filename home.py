...
st.subheader("""🌐 Unlock the future of healthcare with Medi-RAG, a 
             ...
             with precision. 
             Designed to support doctors, researchers, and healthcare professionals, 
             Medi-RAG combines powerful natural language understanding 📖 with advanced medical data 
             retrieval 📊.""")
