...
st.subheader("🌐 Unlock the future of healthcare with Medi-RAG, a revolutionary tool that leverages AI 🤖 to analyze and summarize complex medical reports with precision.Designed to support doctors, researchers, and healthcare professionals, Medi-RAG combines powerful natural language understanding 📖 with advanced medical data retrieval 📊.")
